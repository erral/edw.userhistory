...
FIXTURE = MyFixture()
FUNCTIONAL_TESTING = FunctionalTesting(bases=(FIXTURE, ), name='MyFixture:Functional')
INTEGRATION_TESTING = IntegrationTesting(bases=(FIXTURE, ), name='MyFixture:Integration')
